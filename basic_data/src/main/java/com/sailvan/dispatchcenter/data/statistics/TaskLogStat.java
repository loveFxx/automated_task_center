...
public class TaskLogStat {
    ...
    public void taskSuccessStat(String oneDayStart, String oneDayEnd, String secondDayStart, String secondDayEnd, String filePath) throws IOException, InterruptedException {
        LinkedHashMap<String, TaskStatDomain> res = getTaskSuccessMap(oneDayStart, oneDayEnd, secondDayStart, secondDayEnd);
    ...
    public LinkedHashMap<String, TaskStatDomain> getTaskSuccessMap(String oneDayStart, String oneDayEnd, String secondDayStart, String secondDayEnd) throws IOException, InterruptedException {
        //返回值
        ...
        //拆分成小String
        ArrayList<String> firstDayCreatedHashKeyList = SplitBigListUtils.BigListToSmallStringLists(TotalHashKeysList, 500);
        ...
        for (String s : firstDayCreatedHashKeyList) {
            ...
            for (Map curMap : eachTaskNameForceFailedCount1) {
                ...
                if (res.containsKey(taskName)) {
                    ...
                    taskStatDomain.setForceFailedList(taskStatDomain.getForceFailedList() + curMap.get("group_concat(task_source_id)").toString() + ",");
                }
            }
        ...
        ArrayList<String> strings1 = SplitBigListUtils.BigListToSmallStringLists(MaxIdOfHashKeyEndedInSecondDay, 500);
        ...
        ArrayList<String> firstDayCreatedAndEndedHashKeyList = SplitBigListUtils.BigListToSmallStringLists(TotalHashKeysList, 500);
        ...
        ArrayList<String> strings = SplitBigListUtils.BigListToSmallStringLists(MaxIdOfHashKeyEndedInFirstDay, 500);
