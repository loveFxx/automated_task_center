...
//亚马逊进程代理IP公共搜索框，使用时需要在引入的模块调用此方法
function amazonDaemonProxySearcher(id){
    layui.use(['form'], function(){
        var form = layui.form;
        $.get("../common/amazonDaemonProxySearcher", function(data){
            $.each(data,function(proxyId,proxyIp){
                $("#"+id).append(new Option(proxyIp, proxyId))
            });
            form.render('select')
        });
    });
