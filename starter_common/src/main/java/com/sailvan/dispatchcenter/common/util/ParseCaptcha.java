...
//        String response = httpClientUtils.post(api, httpEntity);
        ...
        if (String.valueOf(status).equals("200")){
            ...
            if (StringUtils.isEmpty(result)){
                logger.error("ParseCaptcha parse captcha error:{}",response);
            }
            return result;
        }else {
            logger.error("ParseCaptcha parse captcha error:{}",response);
