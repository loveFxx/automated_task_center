        ...
        for (Map<String, String>  map : list) {
            ...
            for (String stat : statArr) {
                ...
                String statValue = stat.split(":")[1];
                    ...
                    map2.put("avgTime",Integer.parseInt(statValueMap[3]));
                    map2.put("totalTime",Integer.parseInt(statValueMap[4]));
                    ...
                    if (globalTreeMap.containsKey(statPeriod)) {
                        ...
                        map3.put("totalTime",curMap.get("totalTime")+Integer.parseInt(statValueMap[4]));
                        //Math.round(xx/0.0)=0
                        map3.put("avgTime",Math.round(map3.get("totalTime")/(float)map3.get("successCount")));
